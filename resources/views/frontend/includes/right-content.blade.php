...
<!--                    <hr>
    ...
    <div class="panel panel-default panel-custom3">
        ...
        <div class="panel-body">
            <span>Which Language you think there is more oportunity for Job?</span> 
            <ul class="list-group" style="border:0px solid silver;margin-bottom: 0px; margin-left: 15px">
                <li class="list-group-item" style="border:1px solid transparent; padding:0px">
                    <div class="radio">
                        <label><input type="radio" name="optionsRadios"> C#.NET</label>
                    </div>
                </li>
                <li class="list-group-item" style="border:1px solid transparent; padding: 0px">
                    <div class="radio">
                        <label><input type="radio" name="optionsRadios"> Java</label>
                    </div>
                </li>
                <li class="list-group-item" style="border:1px solid transparent; padding: 0px">
                    <div class="radio">
                        <label><input type="radio" name="optionsRadios"> PHP</label>
                    </div>
                </li>
            </ul>
