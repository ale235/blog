                    ...
                    <form action="{{ url('/admin/singlepage/aval/'.$aval->id) }}" enctype="multipart/form-data" method="post">
                        ...
                        <div class="row form-group">
                            <div class="col-md-12 {{ $errors->has('title') ? ' has-error' : '' }}">
                                ...
                                <input disabled type="text" name="title" id="title" class="form-control" value="{{ $aval->texto_uno}}">
                                @if ($errors->has('title'))
                        ...
                        <div class="row form-group">
                            <div class="col-md-12 {{ $errors->has('imgportada') ? ' has-error' : '' }}">
                                ...
                                <div class="input-group">
                                    ...
                                    <input disabled id="thumbnail" class="form-control" type="text" name="imgportada" value="{{ $aval->image_path}}">
                                </div>
                            </div>
