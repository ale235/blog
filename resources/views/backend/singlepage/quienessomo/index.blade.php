        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Listado de ¿Quienes Somos?</h3>
                </div>
                <!-- /.box-header -->
                        ...
                        @foreach($quienessomos as $quienessomo)
                            <tr style="
                                ...
                                {{--<div class="btn-group" style="display: inline-block;">--}}
                                    <a href="{{url('/admin/singlepage/quienessomo')}}/{{$quienessomo->id}}" class="btn btn-xs btn-primary edit" id="'.slider->id.'"><i class=""></i> Ver</a>
                                    <a href="{{url('/admin/singlepage/quienessomo')}}/{{$quienessomo->id}}/edit" class="btn btn-xs btn-primary edit" id="'.slider->id.'"><i class=""></i> Editar</a>
                                    <a href="{{url('/admin/singlepage/quienessomo')}}/{{$quienessomo->id}}/delete" class="btn btn-xs btn-primary" ><i class=""></i> Borrar</a>
                                {{--</div>--}}
                                </td>
                            </tr>
