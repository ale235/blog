...
<div class="row">
    ...
    <div class="row">
            <div class="col-12 col-md-12">
                <div class="col-md-12">
                    <form action="{{ url('/admin/singlepage/standsyartista/'.$standyartista->id) }}" enctype="multipart/form-data" method="post">
                        {{ csrf_field() }}
                        ...
                        <div class="row form-group">
                            <div class="col-md-12 {{ $errors->has('title') ? ' has-error' : '' }}">
                                ...
                                <input disabled type="text" name="title" id="title" class="form-control" value="{{ $standyartista->nombre}}">
                                @if ($errors->has('title'))
                        ...
                        <div class="row form-group">
                            <div class="col-md-12 {{ $errors->has('imgportada') ? ' has-error' : '' }}">
                                ...
                                <div class="input-group">
                                    ...
                                    <input disabled id="thumbnail" class="form-control" type="text" name="imgportada" value="{{ $standyartista->image_path}}">
                                </div>
                            </div>
                            <img id="holder" style="margin-top:15px;max-height:100px;" src="{{ asset($standyartista->image_path)}}">
                        </div>
                        ...
                        <div class="row form-group">
                            <div class="col-md-9 {{ $errors->has('slug') ? ' has-error' : '' }}">
                                ...
                                http://
                                <input disabled type="text" name="slug" id="slug" class="" value="{{ $standyartista->slug}}" size="50">
                                @if ($errors->has('slug'))
                                    <span class="form-error">
                                    {{ $errors->first('slug') }}
                                    </span>
                        ...
                        <div class="row form-group">
                            <div class="col-md-9 {{ $errors->has('facebook') ? ' has-error' : '' }}">
                                ...
                                <input disabled type="text" name="facebook" id="facebook" class="" value="{{ $standyartista->facebook}}" size="50">
                        ...
                        <div class="row form-group">
                            <div class="col-md-9 {{ $errors->has('instagram') ? ' has-error' : '' }}">
                                ...
                                <input disabled type="text" name="instagram" id="instagram" class="" value="{{ $standyartista->instagram}}" size="50">
