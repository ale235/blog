                    ...
                    <form action="{{ url('/admin/singlepage/standsyartista/'.$standyartista->id) }}" enctype="multipart/form-data" method="post">
                        ...
                        <div class="row form-group">
                            <div class="col-md-12 {{ $errors->has('title') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="title" id="title" class="form-control" value="{{ $standyartista->nombre}}">
                                @if ($errors->has('title'))
                        ...
                        <div class="row form-group">
                            <div class="col-md-12 {{ $errors->has('imgportada') ? ' has-error' : '' }}">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="thumbnail" class="form-control" type="text" name="imgportada" value="{{ $standyartista->image_path}}">
                                </div>
                            </div>
                        ...
                        <div class="row form-group">
                            <div class="col-md-9 {{ $errors->has('slug') ? ' has-error' : '' }}">
                                ...
                                http://
                                <input type="text" name="slug" id="slug" class="" value="{{ $standyartista->slug}}" size="50">
                                @if ($errors->has('slug'))
                                    <span class="form-error">
                                    {{ $errors->first('slug') }}
                                    </span>
                        ...
                        <div class="row form-group">
                            <div class="col-md-9 {{ $errors->has('facebook') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="facebook" id="facebook" class="" value="{{ $standyartista->facebook}}" size="50">
                        ...
                        <div class="row form-group">
                            <div class="col-md-9 {{ $errors->has('instagram') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="instagram" id="instagram" class="" value="{{ $standyartista->instagram}}" size="50">
