                        ...
                        @foreach($standsyartistas as $standsyartista)
                            <tr style="
                                ...
                                <td>
                                    ...
                                    <a href="{{url('/admin/singlepage/standsyartista')}}/{{$standsyartista->id}}" class="btn btn-xs btn-primary edit" id="'.slider->id.'"><i class=""></i> Ver</a>
                                    <a href="{{url('/admin/singlepage/standsyartista')}}/{{$standsyartista->id}}/edit" class="btn btn-xs btn-primary edit" id="'.slider->id.'"><i class=""></i> Editar</a>
                                    <a href="{{url('/admin/singlepage/standsyartista')}}/{{$standsyartista->id}}/delete" class="btn btn-xs btn-primary" ><i class=""></i> Borrar</a>
                                    {{--</div>--}}
                                </td>
                            </tr>
