...
<div class="row">
    ...
    <div class="row">
            <div class="col-12 col-md-12">
                <div class="col-md-12">
                    <form action="{{ url('/admin/singlepage/sponsor/'.$sponsor->id) }}" enctype="multipart/form-data" method="post">
                        ...
                        <div class="row form-group">
                            <div class="col-md-12 {{ $errors->has('title') ? ' has-error' : '' }}">
                                ...
                                <input disabled type="text" name="title" id="title" class="form-control" value="{{ $sponsor->nombre}}">
                                @if ($errors->has('title'))
                        ...
                        <div class="row form-group">
                            <div class="col-md-12 {{ $errors->has('imgportada') ? ' has-error' : '' }}">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="thumbnail" class="form-control" type="text" name="imgportada" value="{{ $sponsor->image_path}}" onchange="GetFileSize()">
                                </div>
                            </div>
                            <img id="holder" style="margin-top:15px;max-height:100px;" src="{{ asset($sponsor->image_path)}}">
                        </div>
                        ...
                        <div class="row form-group">
                            <div class="col-md-9 {{ $errors->has('slug') ? ' has-error' : '' }}">
                                ...
                                http://
                                <input disabled type="text" name="slug" id="slug" class="" value="{{ $sponsor->slug}}" size="50">
                                @if ($errors->has('slug'))
                                    <span class="form-error">
                                    {{ $errors->first('slug') }}
                                    </span>
