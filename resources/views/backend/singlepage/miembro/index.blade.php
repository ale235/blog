                        ...
                        @foreach($miembros as $miembro)
                            <tr style="
                                ...
                                {{--<td>--}}
                                    ...
                                    {{--</div>--}}
                                {{--</td>--}}
                                <td class="index">{{$miembro->orden}}</td>
                                <td>
                                    <label class="switch">
                                        <input class="estado" type="checkbox" @if($miembro->estado) checked @endif>
...
{{--                            @include('backend.slider.modal')--}}
            ...
            <!-- /.box-body -->
                <div class="box-footer">
                    <a  href="{{url('/admin/singlepage/miembro/create/')}}"><button type="button" class="btn btn-default pull-left"><i class="fa fa-plus"></i> Agregar Stand y/o Artista</button></a>
                </div>
            </div>
            <!-- /.box -->
        </div>
...
<script>
        ...
        updateIndex = function(e, ui) {
            $('td.index', ui.item.parent()).each(function (i) {
                ...
                $.ajax({
                    ...
                    url: '{{ route('ordenarMiembros') }}', // This is the url we gave in the route
    ...
    $(".estado").change(function(){
        if($(this).prop("checked") == true){
            ...
            $.ajax({
                type: 'get', // Type of response and matches what we said in the route
                url: '{{ route('cambiarEstadoMiembros') }}', // This is the url we gave in the route
