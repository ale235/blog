                    ...
                    <form action="{{ url('/admin/singlepage/miembro/'.$miembro->id) }}" enctype="multipart/form-data" method="post">
                        ...
                        <div class="row form-group">
                            <div class="col-md-12 {{ $errors->has('title') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="title" id="title" class="form-control" value="{{$miembro->nombre}}">
                                @if ($errors->has('title'))
                        ...
                        <div class="row form-group">
                            <div class="col-md-12 {{ $errors->has('texto_uno') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="texto_uno" id="texto_uno" class="form-control" value="{{ $miembro->texto_uno}}">
                        ...
                        <div class="row form-group">
                            <div class="col-md-12 {{ $errors->has('texto_dos') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="texto_dos" id="texto_dos" class="form-control" value="{{ $miembro->texto_dos}}">
                        ...
                        <div class="row form-group">
                            <div class="col-md-12 {{ $errors->has('imgportada') ? ' has-error' : '' }}">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="thumbnail" class="form-control" type="text" name="imgportada" value="{{ $miembro->image_path}}">
                                </div>
                            </div>
                        ...
                        <div class="row form-group">
                            <div class="col-md-9 {{ $errors->has('slug') ? ' has-error' : '' }}">
                                ...
                                http://
                                <input type="text" name="slug" id="slug" class="" value="{{ $miembro->slug}}" size="50">
                                @if ($errors->has('slug'))
                                    <span class="form-error">
                                    {{ $errors->first('slug') }}
                                    </span>
                        ...
                        <div class="row form-group">
                            <div class="col-md-9 {{ $errors->has('facebook') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="facebook" id="facebook" class="" value="{{ $miembro->facebook}}" size="50">
                        ...
                        <div class="row form-group">
                            <div class="col-md-9 {{ $errors->has('instagram') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="instagram" id="instagram" class="" value="{{ $miembro->instagram}}" size="50">
                        ...
                        <div class="row form-group">
                            <div class="col-md-9 {{ $errors->has('twitter') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="twitter" id="twitter" class="" value="{{ $miembro->twitter}}" size="50">
