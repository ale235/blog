...
<div class="row">
    ...
    <div class="row">
            <div class="col-12 col-md-12">
                <div class="col-md-12">
                    <form action="{{ url('/admin/singlepage/miembro/store') }}" id="form-galery" enctype="multipart/form-data" method="post">
                        {{ csrf_field() }}
                        ...
                        <div class="row form-group">
                            <div class="col-md-12 {{ $errors->has('texto_uno') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="texto_uno" id="texto_uno" class="form-control" value="{{ old('texto_uno')}}">
                        ...
                        <div class="row form-group">
                            <div class="col-md-12 {{ $errors->has('texto_dos') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="texto_dos" id="texto_dos" class="form-control" value="{{ old('texto_dos')}}">
                        ...
                        <div class="row form-group">
                            <div class="col-md-9 {{ $errors->has('twitter') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="twitter" id="twitter" class="" value="{{ old('twitter')}}" size="50">
